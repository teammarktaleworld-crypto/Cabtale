          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
            Container(
              ...
              child: Column(children: [
                ...
                Image.asset(Images.referralIcon1,height: 24,width: 24,color: Theme.of(context).textTheme.bodyLarge!.color),
                const SizedBox(height: Dimensions.paddingSizeSmall),
            ...
            Container(
              ...
              child: Column(children: [
                ...
                Image.asset(Images.referralIcon2,height: 24,width: 24,color: Theme.of(context).textTheme.bodyLarge!.color),
                const SizedBox(height: Dimensions.paddingSizeSmall),
            ...
            Container(
              ...
              child: Column(children: [
                ...
                Image.asset(Images.referralIcon3,height: 24,width: 24,color: Theme.of(context).textTheme.bodyLarge!.color),
                const SizedBox(height: Dimensions.paddingSizeSmall),
