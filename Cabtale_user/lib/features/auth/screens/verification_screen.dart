                ...
                SizedBox(
                  ...
                  child: MaterialPinField(
                    ...
                    theme: MaterialPinTheme(
                      ...
                      focusedBorderColor: Theme.of(context).primaryColor.withOpacity(0.2),
                      focusedFillColor: Get.isDarkMode ? Colors.grey.withOpacity(0.6) : Colors.white,
                      fillColor: Theme.of(context).cardColor,
                      borderColor: Theme.of(context).hintColor,
                      filledBorderColor: Theme.of(context).hintColor,
