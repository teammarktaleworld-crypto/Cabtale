...
class AppConstants {
  ...
  static const Color lightPrimary = Color(0xFF384B70);
  static const Color whiteless = Colors.white70;

  static const Color lightSecondary = Color(0xff384B70);
  static const Color darkPrimary = Color(0xff4C5B85);
